...
@onready var item_container: VBoxContainer = $ShopUI/Panel/ItemContainer
@onready var player_weapons_container: VBoxContainer = $ShopUI/Panel/PlayerWeaponsContainer
@onready var close_button: Button = $ShopUI/Panel/CloseButton
...
func show_purchase_notification(message: String, is_success: bool) -> void:
	var game_manager = get_tree().get_first_node_in_group("game_manager")
